...
{
    if( ! defined( 'VC_PAGE_BUILDER_PLUGIN_URL' ) ) define( 'VC_PAGE_BUILDER_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
    if( ! defined( 'VC_PAGE_BUILDER_PLUGIN_PATH' ) ) define( 'VC_PAGE_BUILDER_PLUGIN_PATH', plugin_dir_path( __FILE__ ) );

    $plugin = new VC\PageBuilder\Bootstrap();
    $plugin->run();
}
