		...
		<div class="span12">
			...
			<div class="twine-widget">
				...
				<div class="twine-widget-content">
					...
					<P ><a href="<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a> provides the tools you need to grow and engage your social audience. Display any social media content on your digital properties, and drive massive social engagement.</p>
					...
					<P>IMPORTANT: You will FIRST need to go to <a href="http://<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a>, sign up for a FREE account before you can embed it into your Wordpress site.
					</div>
					...
					<H3>Installation</H3>
					<P>First, go to <a href="http://<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a> and sign up for a FREE account. Installing the plugin without a <a href="http://<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a> account will not work properly.</p>
					...
					<P><A href="http://<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a> provides the tools you need to grow and engage your social audience. Display any social media content on your digital properties, and drive massive social engagement.</p>
					...
					<P>First sign up for a free account at <a href="http://<?php echo TWINE_PUBLIC_URL?>?utm_source=wordpress">TwineSocial</a>. This Wordpress plugin then allows you to embed your TwineSocial feed into your WordPress site. Go to the ShortCode tab to easily learn how.</p>

					<H4>I'm stuck. Now what?</H4>
					<P>Feel free to Tweet us at @twinesocial, visit our <a href="http://www.facebook.com/TwineSocial">Facebook Page</a>, visit our <a href="http://support.twinesocial.com">support forum</a>. You can also read our extensive <a href="http://www.twinesocial.com/docs?utm_source=wordpress">online documentation</a>.</p>
				</div>
			</div>
		</div>
	</div>
