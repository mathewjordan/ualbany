...
<div class="row-fluid">
	<div class="span12" style="text-align:center;">
		<a href="<?php echo TWINE_PUBLIC_URL?>/signup/new?utm_source=wordpress&network=Twitter&redirect=<?php echo urlencode($protocol . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"])?>" class="btn btn-default twitter"><i class="fa fa-twitter"></i> Connect Twitter Account</a>
		<a href="<?php echo TWINE_PUBLIC_URL?>/signup/new?utm_source=wordpress&network=Facebook&redirect=<?php echo urlencode($protocol . $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"])?>" class="btn btn-default facebook"><i class="fa fa-facebook"></i> Connect Facebook Account</a>
	</div>
</div>
