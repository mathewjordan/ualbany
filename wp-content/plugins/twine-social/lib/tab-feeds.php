				...
				<div class="twine-widget-content">
					...
					<?php foreach ($campaign->feeds as $feed) { ?>
						<TR>
							...
							<TD><a target="_blank" class="btn btn-sm btn-default" href="http://<?php echo TWINE_CUSTOMER_URL?>/app/<?php echo $campaign->baseUrl?>/feeds/index">Edit Feed</a></TD>
						</TR>
					<?php } ?>
					<?php } ?>
					</tbody>
					...
					<a class="btn btn-sm btn-primary" target="_blank" href="http://<?php echo TWINE_CUSTOMER_URL?>/app/<?php echo $campaign->baseUrl?>/feeds/index">Add Feed</a>
