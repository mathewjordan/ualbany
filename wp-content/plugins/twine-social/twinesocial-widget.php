 ...
 * Description: Display your social media content with the Twine Social Wordpress plugin&mdash;including hashtags and user content&mdash;in a beautiful and richly interactive view.
 * Version: 2.92
...
add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), 'twine_add_action_links' );
    function twine_add_action_links ( $links ) {
        ...
        $links[] = '<a href="http://www.twinesocial.com/?utm_source=wordpress" target="_blank">Visit TwineSocial Website<a>';
        return $links;
    }
