...
<div class="switch"></div></label>
    ...
    <a href="https://instagram.com/oauth/authorize/?client_id=3a81a9fa2a064751b8c31385b91cc25c&scope=basic+public_content&redirect_uri=https://smashballoon.com/instagram-feed/instagram-token-plugin/?return_uri=https://www.arrowplugins.com/instagram-access-token-user-id/&response_type=token" target="_blank" class="insta-default"><i class="fa fa-instagram"></i> Click here to get your Access Token and User ID </a>
</div>
<span style="font-size: 17px;
 ...
 <input style="display:  inline-block;width: 400px;" type="text" id="sfbap1_private_access_token" name="sfbap1_private_access_token" placeholder="Paste Access Token Here" value="<?php echo $sfbap1_private_access_token; ?>" /> 
    ...
    margin-top: -9px;" for="sfbap1_show_photos_from_id_instagram"><strong>User ID:</strong></label> 
              ...
              <td>
                <input style="display:  inline-block;" type="text" id="sfbap1_show_photos_from_id_value" name="sfbap1_user_id_instagram" placeholder="355477699" value="<?php echo $sfbap1_user_id_instagram; ?>" /> <strong>Example: 355477699</strong>
              </td>
            </tr>
            <tr>
              <td>
...
<script type="text/javascript">
    var $boxes1 = jQuery('input[name=sfbap1_enable_facebook_feed]:checked');
    var $boxes2 = jQuery('input[name=sfbap1_enable_twitter_feed]:checked');
    var $boxes3 = jQuery('input[name=sfbap1_enable_instagram_feed]:checked');
    var $boxes4 = jQuery('input[name=sfbap1_enable_pinterest_feed]:checked');
    var $boxes5 = jQuery('input[name=sfbap1_enable_vk_feed]:checked');

    if($boxes1.length == 0 && $boxes2.length == 0 && $boxes3.length == 0 && $boxes4.length == 0 && $boxes5.length == 0){
