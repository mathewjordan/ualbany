...
@section('content')
    ...
    <article @php(post_class())>
        ...
        <section class="section-page-main section-grid-main">
            <div class="container">
                @php(the_field('grid_body'))
            </div>
        </section>
        <section class="section-grid-break">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12"> @php(the_field('grid_left')) </div>
                    <div class="col-sm-6 col-xs-12"> @php(the_field('grid_right')) </div>
                </div>
            </div>
        </section>
        <section class="section-grid-subfooter">
            <div class="container">
                @php(the_field('grid_subfooter'))
            </div>
        </section>
